...
__author__      = ["Edemar Morsch Filho", "Laio Oriel Seman", "Gabriel Mariano Marcelino"]
__copyright__   = "Copyright The PySPIS Contributors"
__credits__     = ["Edemar Morsch Filho", "Laio Oriel Seman", "Gabriel Mariano Marcelino"]
__license__     = "LGPLv3"
__version__     = "0.0.3"
